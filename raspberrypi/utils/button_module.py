...
class ButtonHandler:
    def __init__(self, photo_callback=None, back_callback=None, scroll_down_callback=None, 
                bluetooth_pairing_callback=None, bluetooth_confirm_callback=None):

        # button wiring
        self.photo_button = Button(4, bounce_time=0.5)
        self.back_button = Button(22, bounce_time=0.5)
        ...
        self.back_button.when_pressed = self.handle_back_press
